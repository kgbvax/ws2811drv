...
set_property PACKAGE_PIN G17 [get_ports o_RX_DV]
set_property IOSTANDARD LVCMOS33 [get_ports i_RX_Serial]
set_property IOSTANDARD LVCMOS33 [get_ports i_Clk]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[0]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[1]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[2]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[3]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[4]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[5]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[6]}]
set_property IOSTANDARD LVTTL [get_ports {o_RX_Byte[7]}]




set_property DRIVE 12 [get_ports {o_RX_Byte[7]}]
set_property SLEW SLOW [get_ports {o_RX_Byte[7]}]
